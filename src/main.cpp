...
unsigned int nStakeMinAge = 1 * 60 * 60; // 1 h
...
const string strMessageMagic = "SynchrotronCoin Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees)
{
           int64_t nSubsidy = 0;
            ...
            if(nBestHeight == 0)
            {
            nSubsidy = 25111000 * COIN; //premine 
			}
...
static const int64_t nTargetTimespan = 3 * 60;  // 16 mins
